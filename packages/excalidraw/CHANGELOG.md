...
- Removed `window.EXCALIDRAW_ASSET_PATH` as it's no longer needed, due to inlining assets directly inside the SVGs. [#8012](https://github.com/excalidraw/excalidraw/pull/8012)
